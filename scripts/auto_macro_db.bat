...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "if (-not (Invoke-RetryPython 'scripts\economic_sync_to_neon.py' 'economic_sync_to_neon.py' '--start-date 2026-01-01' 900)) { Write-Log 'ERROR' 'economic_sync_to_neon.py failed after 3 retries'; exit 1 }" ^
